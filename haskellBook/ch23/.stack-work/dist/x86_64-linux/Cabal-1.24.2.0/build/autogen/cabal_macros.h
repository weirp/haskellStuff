...
/* package ch23-0.1.0.0 */
#define VERSION_ch23 "0.1.0.0"
#define MIN_VERSION_ch23(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "ch23-0.1.0.0"

#define CURRENT_PACKAGE_KEY "ch23-0.1.0.0"
