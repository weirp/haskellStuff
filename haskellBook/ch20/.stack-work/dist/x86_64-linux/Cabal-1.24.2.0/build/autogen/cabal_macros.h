...
/* package ch20-0.1.0.0 */
#define VERSION_ch20 "0.1.0.0"
#define MIN_VERSION_ch20(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "ch20-0.1.0.0"

#define CURRENT_PACKAGE_KEY "ch20-0.1.0.0"
